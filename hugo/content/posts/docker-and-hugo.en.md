+++
title       = "Como eu criei e deployei este site com Hugo e Docker"
linktitle   = "Como eu criei e deployei este site com Hugo e Docker"
description = "Como eu criei e deployei este site com Hugo e Docker"
date        = "2019-04-25"
type        = "post"
comments    = true
...
Criar um site pessoal é uma tarefa trivial. Existem diversas opções no mercado, desde opções para leigos totais, como o [Wix](https://pt.wix.com/), ou plataformas mais robustas (e, neste caso, de qualidade questionável), como o [Wordpress](https://wordpress.com/). No entanto, caso se queira 
